                    ...
                    <li>
                        <a href="#"
                            ...
                            <svg class="w-6 h-6 text-emerald-400 group-hover:scale-110 transition-transform" fill="none"
                                stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M13 7l4 4-4 4m0 0l-4 4-4-4m4-4l-4-4"></path>
                            </svg>
                            <span>Replies</span>
                        </a>
                    </li>
            ...
            <header class="bg-white border-b h-16 fixed top-0 right-0 left-0 lg:left-64 z-10 shadow-sm">
                <div class="flex items-center justify-between h-full px-4 sm:px-6">
                    ...
                    <div class="flex items-center gap-2 sm:gap-3">
                        <svg class="w-5 h-5 sm:w-6 sm:h-6 text-emerald-500" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="flex items-center gap-3 sm:gap-4">
                        ...
                        <div class="relative group">
                            <a href="#" class="p-2 hover:bg-gray-100 rounded-full transition-all relative">
                                <span
                                    class="absolute -top-1 -right-1 h-4 w-4 bg-red-500 text-xs text-white rounded-full flex items-center justify-center">5</span>
                                <svg class="w-5 h-5 sm:w-6 sm:h-6 text-gray-600 group-hover:text-emerald-500 transition-colors"
                        ...
                        <div class="flex items-center gap-2 sm:gap-3">
                            <div class="flex items-center gap-2 sm:gap-3 bg-gray-50 px-2 sm:px-3 py-1 rounded-full">
                                <div
                                    class="w-7 h-7 sm:w-9 sm:h-9 rounded-full border-2 border-emerald-500 overflow-hidden">
                                    <img src="{{ session('user')->profile_picture ? asset('storage/' . session('user')->profile_picture) : asset('default.png') }}"
                                        alt="Profile" class="w-full h-full object-cover">
                                </div>
                            ...
                            <a href="{{ route('logout') }}" class="group p-2 hover:bg-red-50 rounded-full transition-all">
                                <svg class="w-5 h-5 sm:w-6 sm:h-6 text-red-400 group-hover:text-red-600 group-hover:scale-110 transition-all"
                                    fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1">
                                    </path>
