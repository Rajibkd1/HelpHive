                ...
                <div class="flex items-center justify-between h-full px-4">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <a href="#" class="relative p-2 hover:bg-gray-100 rounded-full transition-all">
                            <span
                                class="notification-badge absolute top-0 right-0 h-4 w-4 bg-red-500 text-xs text-white rounded-full flex items-center justify-center">5</span>
                        ...
                        <a href="#" class="relative p-2 hover:bg-gray-100 rounded-full transition-all">
                            <span
                                class="notification-badge absolute top-0 right-0 h-4 w-4 bg-red-500 text-xs text-white rounded-full flex items-center justify-center">3</span>
                            <svg class="w-6 h-6 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
