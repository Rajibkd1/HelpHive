...
@section('sidebar-content')
    ...
    <body class="bg-gray-50 p-6">
        ...
        <div class="max-w-7xl mx-auto">
            <h1 class="text-2xl font-semibold text-gray-900 mb-6">Tickets - Priority: {{ ucfirst($priority) }}</h1>
            ...
            <div class="bg-white rounded-lg shadow-sm overflow-hidden mt-6">
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            <th scope="col"
                                class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Serial
                            </th>
                            <th scope="col"
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @if ($tickets->isEmpty())
                            <tr>
                                <td colspan="7" class="text-center py-4">No tickets found for this priority.</td>
                            </tr>
                        @else
                            @foreach ($tickets as $index => $ticket)
                                <tr class="hover:bg-gray-50 cursor-pointer">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"
                                        onclick="window.location='{{ route('ticket.details', $ticket->id) }}'">
                                        {{ $ticket->title }}</td>
