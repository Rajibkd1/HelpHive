...
<script>
    ...
    console.log(@json($monthlyTickets));
    ...
    new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                data: @json(array_values($monthlyTickets)),  // Ensure correct format (array_values removes the keys)
                fill: true,
    ...
    {{-- <script>
        // Ensure the correct format of the monthlyTickets data
        const ctx = document.getElementById('ticketsChart').getContext('2d');
        new Chart(ctx, {
            type: 'line',
            data: {
                ...
                datasets: [{
                    label: 'Created Tickets',
                    data: @json(array_values($monthlyTickets)),  // Ensure the format is correct
                    fill: true,
                    backgroundColor: 'rgba(59, 130, 246, 0.2)', // Light blue with opacity
                    borderColor: 'rgb(59, 130, 246)', // Blue
                    tension: 0.4,
